...
data_root = 'C:/Users/tyler/python_workspace/UCLA/ece188/data_voc'
backend_args = None
train_pipeline = [
        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    type='VOCDataset',
                    data_root=
                    'C:/Users/tyler/python_workspace/UCLA/ece188/data_voc',
...
log_level = 'INFO'
load_from = '../kitti_train/faster_rcnn/epoch_4.pth'
resume = True
max_epochs = 6
...
launcher = 'none'
work_dir = '../kitti_train/faster_rcnn'
